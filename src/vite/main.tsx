...
createRoot(document.getElementById("root") as HTMLElement).render(
  <div className="" style={{ backgroundColor: "#ff0" }}>
    <p className="test transition-400 bg-green active:hover:[h:10%,text:#f00,bg:#ff0,border:#0af,m:100px,p:100px,border-solid]">test</p>
    <button
