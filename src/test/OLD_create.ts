...
// const getBoxShadow = (boxShadow: { [key: string]: string }) => {
//   return (
//     "\n\n" +
...
//   );
// };
// const getThemes = (themes: { [key: string]: { [key: string]: string } }) => {
//   const themeCalls = {};
...
// function getBorderRadius(borderRadius: { [key: string]: string }) {
//   return (
//     "\n\n" +
...
// function getBorderWidth(borderWidth: { [key: string]: string }) {
//   return (
//     "\n\n" +
...
//   .flex,.row,.col,.wrap{display:flex;}
